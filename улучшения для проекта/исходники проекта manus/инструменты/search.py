...
def search(
    ...
    queries: List[str],
    time: Optional[Literal["all", "past_day", "past_week", "past_month", "past_year"]] = None,
) -> Dict[str, Any]:
  ...
  """
  print(f"Simulating search tool call: brief=\\\\'{brief}\\\\' type={type}, queries={queries}, time={time}")
